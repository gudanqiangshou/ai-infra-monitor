...
# 中国四大云 Capex (季度，亿人民币)
# 来源：各公司财报及公开披露 + 行业研报
# 注：阿里、腾讯有上市公司财报；字节、百度部分基于行业研究估算
# ======================================================================
CHINA_CAPEX = [
    # company, year, quarter, capex_cny_bn, source
    # ---------- 2024 ----------
    ("Alibaba", 2024, 1, 116, "财报"),
    ("Alibaba", 2024, 2, 119, "财报"),
    ("Alibaba", 2024, 3, 175, "财报"),
    ("Alibaba", 2024, 4, 318, "财报"),  # Q4突增
    ("Tencent", 2024, 1, 144, "财报"),
    ("Tencent", 2024, 2, 84, "财报"),
    ("Tencent", 2024, 3, 171, "财报"),
    ("Tencent", 2024, 4, 366, "财报"),
    ("ByteDance", 2024, 1, 200, "行业研报"),
    ("ByteDance", 2024, 2, 250, "行业研报"),
    ("ByteDance", 2024, 3, 380, "行业研报"),
    ("ByteDance", 2024, 4, 470, "行业研报"),
    ("Baidu", 2024, 1, 32, "财报"),
    ("Baidu", 2024, 2, 35, "财报"),
    ("Baidu", 2024, 3, 40, "财报"),
    ("Baidu", 2024, 4, 55, "财报"),
    # ---------- 2025 ----------
    ("Alibaba", 2025, 1, 245, "财报"),
    ("Alibaba", 2025, 2, 386, "财报"),
    ("Alibaba", 2025, 3, 510, "财报"),
    ("Alibaba", 2025, 4, 600, "财报"),
    ("Tencent", 2025, 1, 275, "财报"),
    ("Tencent", 2025, 2, 191, "财报"),
    ("Tencent", 2025, 3, 280, "财报"),
    ("Tencent", 2025, 4, 380, "财报"),
    ("ByteDance", 2025, 1, 550, "行业研报"),
    ("ByteDance", 2025, 2, 700, "行业研报"),
    ("ByteDance", 2025, 3, 850, "行业研报"),
    ("ByteDance", 2025, 4, 1100, "行业研报"),
    ("Baidu", 2025, 1, 65, "财报"),
    ("Baidu", 2025, 2, 70, "财报"),
    ("Baidu", 2025, 3, 78, "财报"),
    ("Baidu", 2025, 4, 95, "财报"),
    # ---------- 2026 Q1 ----------
    ("Alibaba", 2026, 1, 720, "财报指引"),
    ("Tencent", 2026, 1, 420, "财报"),
    ("ByteDance", 2026, 1, 1300, "行业研报"),
    ("Baidu", 2026, 1, 110, "财报"),
]
